    ...
    <form className={styles.Options} onSubmit={handleSubmit}>
      <section>
        ...
        <div>
          <select name="size" value={size} onChange={handleChange}>
            <option name="size" value="any">Any Maze Size</option>
        ...
        <div>
          <select name="cellShape" value={cellShape} onChange={handleChange}>
            <option name="cellShape" value="any">Any Cell Shape</option>
      ...
      <div>
        <select name="algorithm" value={algorithm} onChange={handleChange}>
          <option name="algorithm" value="any">Any Generation Algorithm</option>
          ...
          <option name="algorithm" value="Woven">Woven (Cell Shape must be &apos;Square&apos;)</option>
        </select>
      </div>
      <div>
